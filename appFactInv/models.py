...
class personas(models.Model):
    ...
    nit_persona=models.CharField(max_length=10 )
    telefono_persona=models.CharField(null=True,blank=True, max_length=8)


    
    def __str__(self):
          return '%s %s' % (self.nombre_persona, self.apellido_persona)
...
class agregar_productos(models.Model):
    ...
    cantidad_agregar=models.PositiveIntegerField(null=True,blank=True)
